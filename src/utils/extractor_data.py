...
for model, group in filtered_df.groupby("Model"):
    ...
    spec_info = {
        ...
        "only_superserver": get_str_or_empty(row, "For Superserver Only"),
    ...
    for _, row in group.iterrows():
        ...
        part = {
            ...
            "info": {
                ...
                "part_type": str(row["partsType"]).strip()
            }
        }
        parts.append(part)
...
with open("merged_motherboards.csv", "w", newline='', encoding="utf-8-sig") as f:
